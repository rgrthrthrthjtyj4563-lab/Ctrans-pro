...
export const RESOURCE_PAGES: ResourcePage[] = [
  ...
  { id: 'price-config', module: '规则配置', name: '价目配置', description: '标准价目表与规则', actions: acts('price-config', ['view', 'edit']) },
...
export const PERM_ORGS: PermOrg[] = [
  ...
  { id: 'org-group-3', name: '业务三组', type: 'group', parentId: 'org-provider-east' },
  { id: 'org-group-1', name: '业务一组', type: 'group', parentId: 'org-provider-smart' },
];
...
export const PERM_USERS: PermUser[] = [
  ...
  { id: 'u-liuyang', name: '刘洋', account: 'liuyang', orgId: 'org-group-1', orgName: '业务一组', accountStatus: 'enabled' },
  { id: 'u-yangming', name: '杨明', account: 'yangming', orgId: 'org-group-3', orgName: '业务三组', accountStatus: 'enabled' },
  { id: 'u-huangfeng', name: '黄峰', account: 'huangfeng', orgId: 'org-group-3', orgName: '业务三组', accountStatus: 'enabled' },
  { id: 'u-wuchao', name: '吴超', account: 'wuchao', orgId: 'org-group-3', orgName: '业务三组', accountStatus: 'disabled' },
...
export const seedGrants: UserGrant[] = [
  ...
  { id: 'g-06', userId: 'u-liuyang', roleId: 'role-group-lead', orgId: 'org-group-1', orgName: '业务一组', scope: 'GROUP', effectiveFrom: '2026-05-08', grantedBy: '陈伟', grantedAt: '2026-05-08 09:30', status: 'active' },
  { id: 'g-07', userId: 'u-yangming', roleId: 'role-specialist', orgId: 'org-group-3', orgName: '业务三组', scope: 'SELF', effectiveFrom: '2026-06-01', grantedBy: '陈伟', grantedAt: '2026-06-01 11:05', status: 'active' },
  { id: 'g-08', userId: 'u-huangfeng', roleId: 'role-specialist', orgId: 'org-group-3', orgName: '业务三组', scope: 'SELF', effectiveFrom: '2026-06-01', grantedBy: '陈伟', grantedAt: '2026-06-01 11:06', status: 'active' },
  { id: 'g-09', userId: 'u-wuchao', roleId: 'role-specialist', orgId: 'org-group-3', orgName: '业务三组', scope: 'SELF', effectiveFrom: '2026-06-01', effectiveTo: '2026-08-01', grantedBy: '陈伟', grantedAt: '2026-06-01 11:07', status: 'expired' },
...
export const seedPermAudit: PermAuditEvent[] = [
  ...
  { id: 'PE00075', time: '2026-08-23 14:18', actor: '杨明', actorRole: '服务专员', org: '业务三组', target: '结算明细', roleName: '服务专员', module: '结算明细', action: '越权访问', resource: 'settlement.approve', decision: '拒绝', reason: '无审核/确认权限', requestId: 'req-8231418', ip: '10.9.12.7', result: '失败' },
